...
// https://raw.githubusercontent.com/boostorg/asio/develop/example/cpp14/executors/fork_join.cpp
...
private:
  ...
  asio::static_thread_pool threads_;
};
...
public:
  ...
  fork_join_pool& query(asio::execution::context_t) const noexcept
  {
    return context_;
  }
